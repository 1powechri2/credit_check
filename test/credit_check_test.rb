...
cardnum = 4929735477250543
  ...
  def test_seperate_every_other_digit_even_index
    credit_check = CreditChecker.new(4929735477250543)

    assert_equal = [4,2,7,5,7,2,0,4], credit_check.seperate_every_other_digit_even_index
  end

  def test_seperate_every_other_digit_odd_index
    credit_check = CreditChecker.new(4929735477250543)

    assert_equal = [9,9,3,4,7,5,5,3], credit_check.seperate_every_other_digit_odd_index
  end
  ...
  def convert_double_digits_to_sigle
    ...
    assert_equal = [9,9,6,8,5,1,1,6], credit_check.convert_double_digits_to_sigle
  end
